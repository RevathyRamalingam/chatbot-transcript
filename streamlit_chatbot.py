...
HOW TO RUN:
    ...
    # Optional: Load from local directory instead of GitHub
    EPISODES_DIR=../path/to/episodes streamlit run streamlit_chatbot.py
"""
...
# Load from GitHub by default, or from local directory if EPISODES_DIR is set
EPISODES_DIR = os.environ.get("EPISODES_DIR", None)
